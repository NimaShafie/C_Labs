...
/***************************************************************/
void FreeMemoryAllocationQuitProgram() {
...
int batchProcessMain() {
	...
	while (i != 5) {
		...
		case SRT:
			...
			break;
		case QUIT:
			FreeMemoryAllocationQuitProgram();
			break;
		case INVALID:
